...
export const SAFETY_CONTACTS: SafetyContact[] = [
  // ── KR ──────────────────────────────────────────────────────────────────
  {
    ...
    hours: '24/7',
    sourceUrl: 'https://mois.go.kr/frt/sub/a06/b10/emergencycall/screen.do',
  ...
  },
  {
    ...
    hours: '24/7',
    sourceUrl: 'https://mogef.go.kr/cc/wcc/cc_wcc_f001.do',
    verifiedAt: VERIFIED_AT,
  },
  {
  ...
  // ── US ──────────────────────────────────────────────────────────────────
  {
    ...
    hours: '24/7',
    sourceUrl: 'https://911.gov/calling-911',
    verifiedAt: VERIFIED_AT,
  },
  {
